...
#           near_identifier columns allowed as LHS only (not RHS)
# permissive: maximize recall, including bucketed continuous RHS;
#             near_identifier columns allowed on both sides
...
GLOBAL_SEARCH_OVERRIDES: dict[str, Any] = {
    ...
    # search_space_mode defaults to "balanced" from SearchConfig.
    # balanced mode allows near_identifier columns as LHS (not RHS),
    # which works well for entity-resolution datasets like dblp10k.
}
